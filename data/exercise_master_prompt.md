...
Structure the plan across three phases:
- Phase 1 Weeks 1–8: build aerobic base and movement foundation
- Phase 2 Weeks 9–16: extend run distance weekly by maximum 10%, KB maintains joint protection
- Phase 3 Weeks 17–24: peak run distance to 20km, KB drops to maintenance, taper in week 23, race week 24

Weekly layout:
- Monday — KB strength, 4-pattern EMOM, every 2 minutes cycle press, row, swing, goblet squat, 3 cycles, core finisher dead bug, 30 minutes total
- Tuesday — Martial arts, 10 min movement prep, 25 min technique, 10 min mobility, 45 minutes total
- Wednesday — Rest
- Thursday — Run, distance and structure varies by phase
- Friday — Martial arts, same structure as Tuesday
- Saturday — KB complex plus run back to back, 5 rounds, movements are swing, clean, push press, goblet squat, row, farmer carry, overhead carry, rest 90 seconds between rounds, run immediately after, 50 minutes total
- Sunday — Active recovery, 25 min easy walk, 15 min mobility, 5 min 4-7-8 breathing

KB weights:
- Swings, rows, farmer carry: 24–32kg
- Goblet squat, front squat: 20–24kg
- Press, clean, push press: 16–20kg
- Overhead carry: 12–16kg

Progression model repeating within each phase:
- Week 1: establish form, baseline weight
...
Thursday run progression Phase 3: 13km building to 20km over 6 weeks, 10km taper week 23, 5km race week Tuesday then rest to race Sunday

Saturday run: Phase 1 easy 10 minutes or Japanese interval walk, Phase 2 easy 20 minutes, Phase 3 tempo 30 minutes with 4 strides at the end

Martial arts intensity: Phase 1 low, Phase 2 moderate, Phase 3 low — protect the body for race prep

Bone density stimulus: farmer carry and overhead carry embedded inside every Saturday complex round, dead bug core work every Monday, strides from week 9 on Thursday
